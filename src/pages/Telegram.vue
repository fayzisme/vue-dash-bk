    ...
    async loadTicket(page = 1) {
      ...
      await axios({
        ...
        .then(response => {
          ...
          // console.log("Total ticket",this.totalTicket)
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              pushDt.data = dataMessage;
              pushDt.type =
                data.data.incomingType == "system" ? "system" : "text";
